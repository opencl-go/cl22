...
// #include "api.h"
// extern cl_int cl22ExtTerminateContextKHR(void *fn, cl_context context);
import "C"
...
//
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/cl_khr_terminate_context.html
...
// terminated.
//
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clTerminateContextKHR.html
// Extension: KhrTerminateContextExtensionName
func (ext *ExtensionTerminateContextKhr) TerminateContext(context Context) error {
	...
	status := C.cl22ExtTerminateContextKHR(ext.clTerminateContextKhr, context.handle())
