...
// #include "api.h"
// extern cl_int cl22EnqueueNativeKernel(cl_command_queue commandQueue,
...
//
// Since: 2.1
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clCloneKernel.html
...
//
// Since: 2.0
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clSetKernelArgSVMPointer.html
...
//
// Since: 2.0
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clSetKernelExecInfo.html
...
//
// Since: 2.1
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clGetKernelSubGroupInfo.html
...
func EnqueueNativeKernel(commandQueue CommandQueue, callback func([]unsafe.Pointer), memObjects []MemObject, waitList []Event, event *Event) error {
	...
	status := C.cl22EnqueueNativeKernel(
		commandQueue.handle(),
		rawArgsPtr,
...
//export cl22GoKernelNativeCallback
func cl22GoKernelNativeCallback(args unsafe.Pointer) {
