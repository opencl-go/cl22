...
// #include "api.h"
// extern cl_int cl22EnqueueSVMFree(cl_command_queue commandQueue,
//    cl_uint svmPointerCount, void *svmPointers,
//    uintptr_t *userData,
//    cl_uint waitListCount, cl_event const *waitList,
//    cl_event *event);
// extern cl_int cl22EnqueueSVMMigrateMem(
...
//
// Since: 2.0
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clSVMAlloc.html
...
//
// Since: 2.0
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clSVMFree.html
...
//
// Since: 2.0
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clEnqueueSvmFree.html
...
//export cl22GoSvmFreeCallback
func cl22GoSvmFreeCallback(commandQueue CommandQueue, svmPointerCount C.cl_uint, svmPointers unsafe.Pointer, userData *C.uintptr_t) {
...
//
// Since: 2.0
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clEnqueueSVMMemcpy.html
...
//
// Since: 2.0
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clEnqueueSVMMemFill.html
...
//
// Since: 2.0
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clEnqueueSVMMap.html
...
//
// Since: 2.0
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clEnqueueSVMUnmap.html
...
//
// Since: 2.1
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clEnqueueSVMMigrateMem.html
func EnqueueSvmMigrateMem(commandQueue CommandQueue, svmPtrs []unsafe.Pointer, sizes []int, flags MemMigrationFlags,
	...
	status := C.cl22EnqueueSVMMigrateMem(
		commandQueue.handle(),
