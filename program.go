...
// #include "api.h"
// extern cl_int cl22BuildProgram(cl_program program,
//    cl_uint numDevices, cl_device_id *devices,
//    char *options, uintptr_t *userData);
// extern cl_int cl22CompileProgram(cl_program program,
//    cl_uint numDevices, cl_device_id *devices,
//    char *options,
//    cl_uint numInputHeaders, cl_program *headers, char **includeNames,
//    uintptr_t *userData);
// extern cl_program cl22LinkProgram(cl_context context,
//    cl_uint numDevices, cl_device_id *devices,
//    char *options,
//    cl_uint numInputPrograms, cl_program *programs,
//    uintptr_t *userData,
//    cl_int *errReturn);
// extern cl_int cl22SetProgramReleaseCallback(cl_program program, uintptr_t *userData);
import "C"
import (
	"fmt"
	"unsafe"
...
//
// Since: 2.1
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clCreateProgramWithIL.html
...
//
// Since: 1.2
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clCreateProgramWithBuiltInKernels.html
...
//export cl22GoProgramBuildCallback
func cl22GoProgramBuildCallback(_ Program, userData *C.uintptr_t) {
...
//
// Since: 2.2
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clSetProgramSpecializationConstant.html
...
//
// Since: 1.2
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clCompileProgram.html
...
//export cl22GoProgramCompileCallback
func cl22GoProgramCompileCallback(_ Program, userData *C.uintptr_t) {
	callbackUserData := userDataFrom(userData)
	callback := callbackUserData.Value().(func())
	callbackUserData.Delete()
	callback()
...
//
// Since: 1.2
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clLinkProgram.html
...
//export cl22GoProgramLinkCallback
func cl22GoProgramLinkCallback(program Program, userData *C.uintptr_t) {
	callbackUserData := userDataFrom(userData)
...
//
// Since: 2.2
// See also: https://registry.khronos.org/OpenCL/sdk/2.2/docs/man/html/clSetProgramReleaseCallback.html
func SetProgramReleaseCallback(program Program, callback func()) error {
	callbackUserData, err := userDataFor(callback)
	if err != nil {
		return err
	}
	status := C.cl22SetProgramReleaseCallback(program.handle(), callbackUserData.ptr)
	if status != C.CL_SUCCESS {
		callbackUserData.Delete()
		return StatusError(status)
	}
...
//export cl22GoProgramReleaseCallback
func cl22GoProgramReleaseCallback(_ Program, userData *C.uintptr_t) {
	callbackUserData := userDataFrom(userData)
	callback := callbackUserData.Value().(func())
	callbackUserData.Delete()
	callback()
