...
// #include "api.h"
// extern CL_CALLBACK void cl22CContextErrorCallback(char const *errorInfo,
...
func cContextErrorCallbackFunc() unsafe.Pointer {
	return C.cl22CContextErrorCallback
}

//export cl22GoContextErrorCallback
func cl22GoContextErrorCallback(errorInfo *C.char, privateInfoPtr *C.uint8_t, privateInfoLen C.size_t, key C.intptr_t) {
